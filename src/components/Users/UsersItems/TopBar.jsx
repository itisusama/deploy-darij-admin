  ...
  return (
    <section className='flex justify-between px-2'>
      ...
      <div className='relative'>
        ...
        <input type="search" id="user-search" class="w-[18rem] block p-2 ps-10 text-sm border border-gray-400 rounded-full" placeholder="Search(comming soon)" required value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}/>
        </form>
      </div>
    </section>
  )
