...
const EditNewMiniGameFiveManagement = () => {
      ...
      <div className="w-full h-[585px] bg-[#FFFFFF] border border-[#E1E5E8] rounded-[30px] overflow-y-auto pb-10">
        ...
        <div className="mx-5">
          ...
          <input
            ...
            className="w-full h-[44px] font-inter outline-none border border-[#D0D5DD] rounded-lg px-3 py-2"
          />
        </div>
            ...
            <div className="mx-5 mt-4">
              ...
              <div className="flex">
                <input
                  ...
                  className="w-[65%] h-[44px] font-inter outline-none border border-[#D0D5DD] rounded-lg px-3 py-2"
                />
                <select
                  name=""
                  id=""
              ...
              <div className="mt-12 flex">
                ...
                <div
                  className="relative w-[34px] h-[34px] mt-1 ml-14 flex items-center justify-center bg-[#FFF1B2] rounded-full cursor-pointer"
                >
              ...
              <div className="mt-14">
                ...
                <div className="">
                  <input
                    ...
                    id="translate"
                    placeholder="Enter topic name"
                    className="w-[70%] h-[44px] font-inter outline-none border border-[#D0D5DD] rounded-lg px-3 py-2"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="flex justify-end mt-5">
          ...
          <button onClick={() => alert("Functionality will be added soon")} className="w-[210px] h-[44px] mr-4 rounded-[100px] px-4 py-2 bg-[#FFC600] font-[600] text-[16px] leading-[24px] flex items-center justify-center space-x-2">
            Save Changes
          </button>
        </div>
...
export default EditNewMiniGameFiveManagement