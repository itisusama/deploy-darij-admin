    ...
    return (
        <div className="overflow-y-auto h-screen custom-scrollbar">
            <div className="w-full min-h-[500px] bg-[#FFFFFF] border border-[#E1E5E8] rounded-[30px] overflow-y-auto pb-10">
                    ...
                    <div className="w-full h-[300px] border border-[#D0D5DD] rounded-lg mt-1">
                        <div className="mx-5 mt-4">
                            ...
                            <div className="flex">
                                ...
                                >
                                    <FaRegTrashAlt onClick={() => alert("Delete Dialogue")} className="text-[#D80027] cursor-pointer" style={{ fontSize: "16px" }} />
                                </div>
                            </div>
                            <div className="mt-12 flex">
                                ...
                                <div
                                    className="w-[34px] h-[34px] mt-1 ml-14 flex items-center justify-center bg-[#E2E2E2] rounded-full cursor-pointer"
                                >
                ...
                <div className="ml-5">
                    <button
                        onClick={() => alert("Do you want to add more?")}
                ...
                <div className="flex justify-end mt-5">
                    <button className="w-[210px] h-[44px] mr-4 rounded-[100px] px-4 py-2 border border-[#FFC600] font-[600] text-[16px] leading-[24px] flex items-center justify-center space-x-2">
                        Cancel
                    </button>
                    <button className="w-[210px] h-[44px] mr-4 rounded-[100px] px-4 py-2 bg-[#FFC600] font-[600] text-[16px] leading-[24px] flex items-center justify-center space-x-2">
                        Add
                    </button>
                </div>
            </div>
