        ...
        <div className='p-6 bg-white rounded-[30px] border mb-24 pb-24'>
         <h2 className='font-inter font-[600] text-[24px]'>Add</h2>
            <div className="mt-4">
                ...
                <input type="text" name="question" id="question" className='w-full border rounded-md p-2' placeholder='Enter the question'/>
            </div>
            {/* active icons */}
                  ...
                  />
                            <section className='absolute top-14 lg:left-3'>
                              ...
                              <div className="flex items-center flex-row gap-2">
                                <img src={imageone} alt="one" className="w-[83px] h-[83px] rounded-[20px]" />
                                <img src={imagetwo} alt="two" className="w-[83px] h-[83px] rounded-[20px]"/>
