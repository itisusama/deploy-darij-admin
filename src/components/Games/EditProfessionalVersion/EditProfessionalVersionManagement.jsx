...
const EditProfessionalVersionManagement = () => {
...
const [url, setUrl] = useState('');
  ...
  return (
    <section className="px-4 overflow-y-auto custom-scrollbar">
        <div className='p-6 bg-white rounded-[30px] border mb-24 pb-24'>
         <h2 className='font-inter font-[600] text-[24px]'>Edit</h2>
            <div className="mt-4">
                ...
                <input type="text" name="question" id="question" value={pv.question} className='w-full border rounded-md p-2' />
            </div>
            {/* active icons */}
        ...
        {/* Text Editor */}
        <div className='mt-4'>
          <div className="w-auto h-[247px] relative mt-4 bg-[#FCFCFD] border-2 border-[#FCFCFD] rounded-md">
                            <ReactQuill
                              value={editorContent}
                            ...
                            <section className='absolute top-14 lg:left-3'>
                              <section className='flex items-center gap-2'>
                                <div className='bg-white p-4 rounded-[24px] border w-[100%] lg:w-[80%]'>
                                  <p className='text-[16px] font-inter font-[400]'>A learning AI named Badrah Fat has experienced a lot of ways of learning a language, and the reactions of the public were shocking.</p>
                                </div>
                              ...
                              <div className="flex items-center flex-row gap-2">
                                ...
                                <div className='border bg-[#ffeaeb] border-[#bc0a2c] rounded-md cursor-pointer'>
                                  <div className='w-[38px] h-[38px] flex justify-center items-center'><RiDeleteBin5Fill className='text-[#bc0a2c]' /></div>
                                </div>
                              </div>
                              </div>
                            </section>
...
export default EditProfessionalVersionManagement
